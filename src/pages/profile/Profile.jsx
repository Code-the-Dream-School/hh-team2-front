...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-custom-light-blue">
      <div className="p-6 bg-white max-w-md w-full mx-auto rounded-lg shadow-lg">
          ...
          <img
            src={
              selectedFile
                ...
                : profile?.profilePhoto?.url || "https://via.placeholder.com/150"
            }
            alt="Profile"
        ...
        <div className="flex justify-center gap-2">
          <button
            ...
            className="px-6 py-2 bg-[#002046] text-white rounded-md hover:bg-[#e65100] transition duration-300"
          >
            Upload
          </button>
        </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg w-80">
              ...
              <form onSubmit={handleUpdateProfile}>
                ...
                <div className="flex justify-between">
                  <button
                    type="submit"
                    className="px-6 py-2 bg-[#002046] text-white rounded-md hover:bg-[#e65100]"
                  >
                    Update
                  </button>
                  <button
              ...
              <button
                ...
                className="mt-4 px-6 py-2 bg-[#002046] text-white rounded-md hover:bg-[#e65100] transition duration-300"
              >
